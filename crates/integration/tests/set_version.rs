...
fn set_versions_in_workspace() {
    ...
    // Add Rust source code
    //
    let lib_crate = CrateModel::new("test_libv", "0.1.0")
        .make_lib()
    ...
    harness.verify_cargo_project("crates/test_libv");
    ...
    //
    harness.write_file_content(
        "crates/test_libv/src/lib.rs",
        "pub fn add(a: i32, b: i32) -> i32 { a + b }",
    );
    harness.commit("crates/test_libv/", "chore: Add add function to test_libv");
    ...
    harness.commit("crates/test_libv/", "chore: Add add2 function to test_libv");
    harness.push_branch("main");
    ...
    harness.commit(
        "crates/test_libv/",
        "docs: Add documentation to add and add2 functions in test_libv",
    );
    harness.push_branch("main");
    ...
    //
    let lib_cargo_toml = harness.read_file_content("crates/test_libv/Cargo.toml");
    assert!(
        lib_cargo_toml.contains("version.workspace = true"),
        "test_libv Cargo.toml does not reference the workspace version"
    );
